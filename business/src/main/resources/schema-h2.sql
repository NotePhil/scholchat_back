...
CREATE TABLE IF NOT EXISTS ressources.message_classe_ids (
                                                             message_id VARCHAR(255) NOT NULL,
    classe_id UUID NOT NULL,
...
ALTER TABLE ressources.messages ADD COLUMN classe_id UUID;
ALTER TABLE ressources.messages ADD CONSTRAINT fk_messages_classe FOREIGN KEY (classe_id) REFERENCES ressources.classes(id);
...
CREATE INDEX IF NOT EXISTS idx_messages_classe ON ressources.messages(classe_id);
CREATE INDEX IF NOT EXISTS idx_messages_expediteur ON ressources.messages(expediteur_id);


CREATE INDEX IF NOT EXISTS idx_message_classe_message ON ressources.message_classe_ids(message_id);
CREATE INDEX IF NOT EXISTS idx_message_classe_classe ON ressources.message_classe_ids(classe_id);