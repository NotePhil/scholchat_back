...
CREATE TABLE IF NOT EXISTS ressources.evenements (
    ...
    CONSTRAINT fk_evenement_canal FOREIGN KEY (canal_id) REFERENCES ressources.canaux(id)
);
...
CREATE TABLE IF NOT EXISTS ressources.interactions (
    ...
    CONSTRAINT fk_interaction_evenement FOREIGN KEY (evenement_id) REFERENCES ressources.evenements(id)
);
