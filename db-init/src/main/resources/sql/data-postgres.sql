...
-- Données de base, adaptées pour PostgreSQL
...
-- Établissements
INSERT INTO etablissements (id, nom, localisation, pays, email, telephone, option_envoi_mail_classe, option_token_general, code_unique, token_general, code_unique_value, gestionnaire_id) VALUES
...
-- Relations professeurs/classes modérées
